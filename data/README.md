...
| concatenated_gzip_members.parquet     | 513 UINT64 numbers compressed using 2 concatenated gzip members (A GZIP member refers to a single compressed file or stream that has been compressed using the GZIP algorithm.) |
