...
| binary_truncated_min_max.parquet | A file containing two columns with truncated max and min statistics and with the expected is_{min/max}_value_exact = false. [Inspired on](https://github.com/apache/arrow-rs/blob/71ac9bd7146565ab47be8053c412b30c0a4c01c6/parquet/src/column/writer/mod.rs#L3089-L3141).|
