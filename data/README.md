...
| non_list_repeated_field.parquet | Backward compatibility for reading non list/map repartition. reproduction from [`apache/arrow-rs#1915`](https://github.com/apache/arrow-rs/issues/1915). |
