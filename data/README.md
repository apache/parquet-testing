...
| binary_truncated_min_max.parquet | A file containing four columns with fully and partially truncated max and min statistics and with the expected is_{min/max}_value_exact.  (see [related issue](https://github.com/apache/parquet-testing/pull/88)).|
