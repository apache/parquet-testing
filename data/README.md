...
| data_index_bloom_encoding_with_length.parquet | optional STRING column. Contains optional metadata: bloom filters with bloom_filter_length, column index, offset index and encoding stats.                                                |
