...
```
[ Column "long_field" [ Dict Index Page [bad crc] | Compressed PLAIN_DICTIONARY(DICT) Contents ][ Page 0 [correct crc] | Compressed PLAIN_DICTIONARY Contents ]]
[ Column "binary_field" [Dict Index Page [bad crc] | Compressed PLAIN_DICTIONARY(DICT) Contents ][ Page 0 [correct crc] | Compressed PLAIN_DICTIONARY Contents ]]
```
