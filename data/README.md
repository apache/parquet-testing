...
| sorting_columns.parquet | INT64 and BYTE_ARRAY columns with first column with nulls_first and descending, second column with not nulls first and ascending. This file contains two row-groups with same data and sorting_columns. |
